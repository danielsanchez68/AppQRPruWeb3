...
let MaquinasDAO_FS = class MaquinasDAO_FS {
    constructor() {
        // Ruta del archivo DB.Json
        this.dbFilePath = './DB/maquinas.json';
    }
    obtener() {
    ...
    actualizar(codigo, uuid) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const maquinas = yield this.obtener();
                const maquina = maquinas.find(maquina => maquina.uuid === uuid);
                //if(!maquina.codigo) {
                maquina.codigo = codigo;
                yield fs_1.default.promises.writeFile(this.dbFilePath, JSON.stringify(maquinas, null, '\t'));
            }
            catch (error) {
...
MaquinasDAO_FS = __decorate([
    (0, inversify_1.injectable)()
], MaquinasDAO_FS);
exports.default = MaquinasDAO_FS;
